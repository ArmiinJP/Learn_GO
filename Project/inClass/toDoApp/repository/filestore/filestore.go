...
func New(path string, serializationMode string) FileStorage{
	return FileStorage{path: path, serializationMode: serializationMode}
}

func (f FileStorage) Save(u entity.User) {
	f.writeUserToFile(u)
}

func (f FileStorage) Read() []entity.User{
	return f.loadUserStorageFromFile()
}

func (f FileStorage) loadUserStorageFromFile() []entity.User {
...
func (f FileStorage) writeUserToFile(user entity.User) {
	var file *os.File
